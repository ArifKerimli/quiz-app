...
function addQuestion(index) {
  heading.innerHTML = "<span>" + htmlQuestions[index].question + "<span>";
}

function addVariants(index) {
  const variantTags =
    "<span class='option'>" +
    htmlQuestions[index].variants[0] +
    "</span>" +
    "<span class='option'>" +
    htmlQuestions[index].variants[1] +
    "</span>" +
    "<span class='option'>" +
    htmlQuestions[index].variants[2] +
    "</span>";
...
function variantSelected(answer) {
  ...
  let correctAnswer = htmlQuestions[value].correctAnswer;
